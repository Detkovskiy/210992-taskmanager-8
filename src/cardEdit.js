...
export class CardEdit {
  ...
  get template() {
    return `<article class="card card--edit card--${this._color} ${this._checkDeadline()} ${this._isRepeated() ? `card--repeat` : ``}" style="">
                ...
                <div class="card__settings">
                  ...
                  <div class="card__colors-inner">
                    ...
                    <div class="card__colors-wrap">
                      ...
                      <input type="radio" id="color-pink-4" class="card__color-input card__color-input--pink visually-hidden" name="color" value="pink" checked="">
  ...
  unbind() {
    this._element.removeEventListener(`submit`, this._onSubmitButtonClick.bind(this));
  }
